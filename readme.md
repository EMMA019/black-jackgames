...
This project was initially designed and generated by Evo-Coder and refined through iterative debugging.
...
│   ├── __init__.py      (Package initializer, must be empty)
...
├── extensions.py          (db, socketio, redis_client instances)
...
git clone [https://github.com/EMMA019/black-jackgames.git](https://github.com/EMMA019/black-jackgames.git)
cd black-jackgames
...
(Terminal 1) Start your Redis Server
If it's not already running, start Redis.
...
In the project's root directory (where wsgi.py is located), run the wsgi.py file.
...
[INFO] wsgi: Game blueprint registered successfully.
